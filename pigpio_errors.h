...
Since this file is mostly a compilation of libpibpio declarations,
it's released to the public domain.  The libpigpio notice to that 
effect is reproduced here:
...
struct err_rec pigpio_errorlist [] {
{"PI_OK",0,"sentinel to place array index in the right place..."},
